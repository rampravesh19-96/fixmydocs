  ...
  return (
    <main className="flex flex-col items-center min-h-screen bg-gray-50 p-4">
      ...
      <h1 className="text-3xl font-bold text-center mb-4">
        SSC Photo & Signature Size + Compressor
      </h1>

      <p className="text-gray-600 text-center max-w-md mb-6">
        Check SSC image size requirements and compress your photo or signature
        to the required KB instantly.
      </p>

      {/* SSC SIZE INFO */}
      <div className="bg-white shadow rounded p-4 max-w-md w-full mb-6 text-sm">
        <h2 className="font-semibold mb-2">SSC Image Requirements</h2>

        <p><strong>Photo:</strong> 20KB – 50KB</p>
        <p><strong>Signature:</strong> 10KB – 20KB</p>
      ...
      <div className="mt-12 max-w-xl text-left">
        ...
        <h2 className="text-xl font-semibold mb-4">
          Image Size for SSC Form (KB, Pixels, CM)
        </h2>

        <p className="text-gray-600 text-sm mb-4">
          SSC forms require specific image sizes for photo and signature.
          Use this tool to compress image size for SSC form online free and
          ensure your upload meets requirements.
        </p>

        <h3 className="font-medium">FAQs</h3>

        <p className="text-sm mt-2">
          <strong>What is SSC photo size?</strong><br />
          Typically between 20KB and 50KB.
        </p>

        <p className="text-sm mt-2">
          <strong>What is SSC signature size?</strong><br />
          Usually between 10KB and 20KB.
        </p>
      ...
      <div className="mt-10 text-center text-blue-600 text-sm flex flex-col gap-2">
        <Link href="/">Compress Image to 50KB</Link>
        <Link href="/compress-pdf-to-100kb">Compress PDF</Link>
      </div>
